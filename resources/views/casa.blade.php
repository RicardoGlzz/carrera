...
<style>
	...
	<section class="casa_wrapper">
		...
		<section class="concepto">
			<h1>Albergue temporal mi C.A.S.A.</h1>
			<div>
				<img src="img/logo_desc.png" alt="">
			</div>
			<div>
				<p>Hace un año se inauguró este albergue con una actividad llamada 12K CHOCHO carrera atlética,con lo recaudado en esta actividad y con el apoyo de muchas personas se logró el pago por adelantado de la renta de un año y la habilitación del mismo, en este albergue atendemos principalmente niños y niñas con cáncer, también atendemos mujeres que reciben tratamientos oncológicos.</p>
				<br>	
				<p>Esto es parte de lo que mes con mes hacemos en C.A.S.A CENTRO DE AYUDA SERVICIO Y APOYO DE DURANGO, A.C</p>
			</div>

			<section class="galeria">
				<h1>Evento realizado en las instalaciones del Bebeleche</h1>
				<section>
					<figure>
						<img src="img/fotos/foto1.jpg" alt="">
					</figure>
					<figure>
						<img src="img/fotos/foto2.jpg" alt="">
					</figure>
					<figure>
						<img src="img/fotos/foto3.jpg" alt="">
					</figure>
					<figure>
						<img src="img/fotos/foto4.jpg" alt="">
					</figure>
					<figure>
						<img src="img/fotos/foto5.jpg" alt="">
					</figure>
					<figure>
						<img src="img/fotos/foto6.jpg" alt="">
					</figure>
				</section>
			</section>
